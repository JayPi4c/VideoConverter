...
public class RelativeLayout implements LayoutManager2, java.io.Serializable {
	...
	private static final long serialVersionUID = -3432032781855442175L;
	 ...
	 * X-AXIS this would refer to the Y alignemt. For Y-AXIS this would refer to the
	 * X alignment.
	 */
	private float alignment = CENTER;

	/**
	 * This is the gap (in pixels) which specifies the space between components It
	 * can be changed at any time and should be a non-negative integer.
	 */
	private int gap;

	/**
	 * The gap (in pixels) used before the leading component and after the trailing
	 * component. It can be changed at any time and should be a non-negative
	 * integer.
	 */
	...
	/**
	 * Creates a relative layout with the components layed out on the X-Axis using
	 * the default gap
	 */
	...
	/**
	 * Gets the initial gap. This gap is used before the leading component and after
	...
	/**
	 * Sets the initial gap. This gap is used before the leading component and after
	 * the trailing component. The default is set to the gap.
	 *
	 ...
	 *
	 * For X-AXIS this would refer to the Y alignemt. For Y-AXIS this would refer to
	 * the X alignment.
	 *
	 ...
	 * RelativeLayout.COMPONENT - the getAlignemntX/Y method for the opposite axis
	 * will be used
	 */
	 ...
	 * aligned components the height will be filled. For Y-AXIS aligned components
	 * the width will be filled.
	 */
	...
	/**
	 * Specify the rounding policy to be used when all the avialable pixels have not
	 * been allocated to a component.
	 *
	 * DO_NOTHING FIRST - extra pixels added to the first relative component LAST -
	 * extra pixels added to the last relative component LARGEST (default) - extra
	 * pixels added to the larger relative component EQUAL - a single pixel is added
	 * to each relative component (until pixels are used up)
	 */
	 ...
	 * layout.
	 * <p>
	 * The preferred width of a column layout is the largest preferred width of each
	 ...
	 * <p>
	 * The preferred height of a column layout is the largest preferred height of
	 ...
	 * columns minus one, plus the left and right insets of the target container.
	 * <p>
	 * The minimum height of a column layout is the largest minimum height of each
	 ...
	 * order to satisfy the constraints of the <code>RelativeLayout</code> object.
	 * <p>
	...
	/*
	 * Each component using relative sizing gets 1 more pixel until all the space is
